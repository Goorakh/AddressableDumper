...
namespace AddressableDumper
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(AddressableDumper) + @"\";
        ...
        public static StringBuilder AppendCallerProjectPath(this StringBuilder stringBuilder, string callerPath)
        {
        ...
        static string buildCallerLogString(string callerPath, string callerMemberName, int callerLineNumber, object data)
        {
            lock (_stringBuilderLock)
            {
                return _sharedStringBuilder.Clear()
                                           .AppendCallerProjectPath(callerPath)
